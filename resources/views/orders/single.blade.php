...
@section('title')
	برنامج ادارة المبيعات - الطلبية رقم {{$order->tracking_number}}
@endsection
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المبيعات</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الطلبية رقم {{$order->tracking_number}}</span>
						</div>
					</div>
				...
				<div class="row">
						...
						<div class="card mg-b-20">
							<div class="card-header pb-0">
                                ...
                                <h3>الطلبية رقم : {{$order->tracking_number}}</h3>

                                <div class="mt-3">
                                            
                                            <p>التاريخ: {{$order->created_at}}</p>
                                            <p>الزبون: زائر</p>
                                            <p>الخصم : {{$order->discount}} درهم</p>
                                </div>
									...
									<table id="example1" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
													...
													<th class="border-bottom-0">حدف</th>
										...
										<tbody>
												@foreach ($orderItems as $x )
													...
													<tr>
														...
														<a href="/orderItem/delete/{{$x->id}}" class="btn btn-danger" title="حذف"><i
