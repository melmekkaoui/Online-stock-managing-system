...
@section('title')
	{{$cart_number}} برنامج ادارة المبيعات - سلة التسوق
@endsection
@section('css')
...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">التسوق</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ سلة التسوق {{$cart_number}}</span>
						</div>
					</div>
	...
	<!------------------------- this is  select by codebar of the produt -------------------->
									<form action="{{route('cart.store')}}" method="post">
										...
										<div class="row row-sm">
											<input type="hidden" value="{{$cart_number}}" name="cart_number" id="">
	...
	<!------------------------------ end the selection by the barcode ---------------------->
							...
							<div class="row row-xs wd-xl-80p">
									...
									<div class="col-sm-6 col-md-3 mg-t-10 mg-sm-t-0">
										<a href="{{url("/cart/".$cart_number."/empty")}}" class="btn btn-danger btn-block">اخلاء السلة</a>
									</div>
							</div>
									...
									<div class="modal-body">
										<form action="{{url('/cart/storeTmp')}}" method="post">
											...
											<div class="form-group"> 
												<input type="hidden" name="cart_number" value="{{$cart_number}}" id="">
